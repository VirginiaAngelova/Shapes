...
button.addEventListener('click', function () {
    var selectValuePosition = document.getElementById('position').value;
    document.getElementById(selectValuePosition).appendChild(figCreate());
});
function figCreate() {
    var selectValueType = document.getElementById('selectType').value;
    var selectValueSize = document.getElementById('size').value;
    var selectValueColor = document.getElementById('colorPicker').value;
